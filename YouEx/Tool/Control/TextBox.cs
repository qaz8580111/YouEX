...
namespace WebSite.Tool.Control
{
    ...
    public class TextBox : System.Web.UI.WebControls.TextBox, IWebControl
    {
        ...
        public TextBox()
            : base()
        {
            base.Attributes.Add("onfocus", "this.className='focustb';");
            base.Attributes.Add("onblur", "this.className='normaltb';");
            base.CssClass = "normaltb";
        }
        ...
        protected override void CreateChildControls()
        {
            ...
            if ((RequiredFieldType != null) && (RequiredFieldType != "") && (RequiredFieldType != "暂无校验"))
            {
                ...
                RequiredFieldTypeREV.CssClass = "warn";
                RequiredFieldTypeREV.ValidationGroup = this.ValidationGroup;
                    ...
                    case "数据校验":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font style='color:red;margin-top: 0px;margin-left: 10px;'>对不起，只能输入数字！</font>"; break;
                        }
                    case "数量":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : "^[0-9]*[1-9][0-9]*$";
                            RequiredFieldTypeREV.ErrorMessage = "<font style='color:red;margin-top: 0px;margin-left: 10px;'>对不起，只能输入正整数数！</font>"; break;
                        }
                    case "电子邮箱":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font style='color:red;margin-top: 0px;margin-left: 10px;'>您的邮箱格式不正确！</font>"; break;
                        }
                    case "移动手机":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : @"^((\+86)|(\(\+86\)))?(((13[0-9]{1})|(15[0-9]{1})|(18[0,5-9]{1})|00852|00886)+\d{8})$";
                            RequiredFieldTypeREV.ErrorMessage = "<font style='color:red;margin-top: 0px;margin-left: 10px;'>手机号码格式不正确！</font>"; break;
                        }
                    case "家用电话":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font style='color:red;margin-top: 0px;margin-left: 10px;'>请依 (XXX)XXX-XXXX 格式或 (XXX)XXXX-XXXX 输入电话号码！</font>"; break;
                        }
                    case "身份证号码":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : "^\\d{15}$|^\\d{18}|^(\\d{17}x)$";
                            RequiredFieldTypeREV.ErrorMessage = "<font style='color:red;margin-top: 0px;margin-left: 10px;'>请依15或18位数据的身份证号！</font>"; break;
                        }
                    case "网页地址":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font style='color:red;margin-top: 0px;margin-left: 10px;'>请输入正确的网址！</font>"; break;
                        }
                    case "日期":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font style='color:red;margin-top: 0px;margin-left: 10px;'>请输入正确的日期,如:2006-1-1</font>"; break;
                        }
                    case "日期时间":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font style='color:red;margin-top: 0px;margin-left: 10px;'>请输入正确的日期,如: 2006-1-1 23:59:59</font>"; break;
                        }
                    case "金额":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font style='color:red;margin-top: 0px;margin-left: 10px;'>请输入正确的金额！</font>"; break;
                        }
                    case "英文":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : "^([a-zA-Z]+?)$";
                            RequiredFieldTypeREV.ErrorMessage = "<font style='color:red;margin-top: 0px;margin-left: 10px;'>请只输入英文字符！</font>"; break;
                        }
                    case "IP地址":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font style='color:red;margin-top: 0px;margin-left: 10px;'>请输入正确的IP地址！</font>"; break;
                        }
                    case "IP地址带端口":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font style='color:red;margin-top: 0px;margin-left: 10px;'>请输入正确的带端口的IP地址！</font>"; break;
                        }
                ...
                case "必填":
                    {
                        ...
                        CanBeNullRFV.ValidationGroup = this.ValidationGroup;
                        CanBeNullRFV.CssClass = "warn";
                        CanBeNullRFV.ErrorMessage = "<font style='color:red;margin-top: 0px;margin-left: 10px;'>对不起,该项不能为空!</font>";
        ...
        public override int MaxLength
        {
            get
            {
                ...
                if (o != null)
                {
                    int maxlength = Int32.Parse(o.ToString());
